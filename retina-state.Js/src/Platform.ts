...
export interface Platform {
  ...
  callEntryPoint (assemblyName: string, entrypointMethod: string, args: Array<(System_Object | null)>);
  findMethod (assemblyName: string, namespace: string, className: string, methodName: string): MethodHandle;
  callMethod (method: MethodHandle, target: System_Object | null, args: Array<(System_Object | null)>): System_Object;
